    ...
    <div class="col-span-12">
      <div class="box">
        <div class="box-header">
          <h5 class="box-title">Ajouter Product</h5>
        </div>
        ...
        <div class="box-body">
          ...
          <div class="col-span-12 xl:col-span-9">
            ...
            <div class="box-footer text-end space-x-3 rtl:space-x-reverse">
              <a href="javascript:void(0);" @click="onClickAddProduct" class="ti-btn m-0 ti-btn-soft-primary"><i
...
const onClickAddProduct = async () => {
 ...
 status.value= await createProduct(product.value);
